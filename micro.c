...
code config[0xFF] = {
    ...
    { 1, 0x5D, 0x5D, 0xFF, 0x00, 7, 0, sdb },   // No Operation
    { 1, 0xF0, 0xF0, 0xFF, 0x00, 2, 0, frk },   // Fork (2 byte addr)
    { 1, 0xF1, 0xF1, 0xFE, 0x00, 1, 0, sig },   // SIGNAL RAISE
    { 1, 0xF2, 0xF2, 0xFE, 0x00, 6, 0, sig },   // SIGNAL KILL
    { 1, 0xF3, 0xF3, 0xFF, 0x00, 3, 0, sih },   // Signal set
